...
![Geria Logo](geria.png)

Professional AI-powered voice cloning application built with XTTS v2 and Streamlit.

## 🚀 Features

- **Real-time Voice Cloning**: Clone any voice with just a few samples
- **Multiple Input Methods**: Type text or upload text files
- **Batch Processing**: Process multiple paragraphs automatically
- **Professional UI**: Dark mode interface with modern design
- **Multiple Formats**: Support for WAV, MP3, and FLAC audio files
- **Download Package**: Get all generated files in a convenient ZIP package
...
For detailed cloud deployment instructions, see [GCP-Instructions.txt](GCP-Instructions.txt)
